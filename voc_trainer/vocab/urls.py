...
urlpatterns = [
    ...
    path('quiz_options/<int:stack_id>/', QuizOptionsView.as_view(), name='quiz_options'),
    path('start-quiz/<int:stack_id>/',
         StartQuizView.as_view(), name='start_quiz'),
    path('start_quiz/<int:stack_id>/', StartQuizView.as_view(), name='start_quiz'),
    path('start_inverse_quiz/<int:stack_id>/', StartInverseQuizView.as_view(), name='start_inverse_quiz'),
